        ...
        public override TranslationList DefaultTranslations
        {
            get
            {
                return new TranslationList
                {
                    ...
                    { "TimeLeft", "Time left for another request: {0}" },
                    { "Delay", "Your teleport will initiate in {0} {1}." },
                    { "Seconds", "seconds" },
                    ...
                    { "error_cooldown", "You may only send requests every {0} seconds." },
                    ...
                    { "request_accepted", "You've accepted {0} TPA request!" },
                    { "request_denied", "You've denied {0}'s request!" },
                    { "request_accepted_1", "{0} accepted your tpa request!" },
                    { "request_accepted_2", "{0} accepted your tpa request and will teleport in {1} {2}." },
                    { "request_accepted_3", "You've accepted {0}'s tpa request and they will teleport in {1} {2}." },
                    { "request_denied_1", "{0} denied your tpa request!" },
                    { "request_sent", "You have sent a tpa request to {0}" },
                    { "request_sent_1", "{0} sent you a tpa request, do /tpa accept to accept!" },
                    { "request_pending", "You already have a request pending to this player." },
                    { "request_none", "You have no requests available!" },
                    { "request_abort", "You have aborted your TPA request." },
